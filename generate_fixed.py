...
model_path = "meta-llama/Llama-2-7b-hf"   # Specify the path to the model
...
model = AutoModelForCausalLM.from_pretrained(model_path, quantization_config=bnb_config, device_map="cpu", load_in_4bit=True,
